    ...
    .container
      .header
        ...
        NAV
          ...
          div(@drop.prevent="productDroped" @dragenter.prevent @dragover.prevent)
            <router-link to="/cart">
...
export default {
  ...
  methods: {
    productDroped() {
      this.$root.cart.push(this.$root.currProduct);
    },
  }
}
</script>
    ...
    a
      ...
      &:hover
        ...
        @media screen and (max-width 600px)
          border-bottom none
      &:active
        border-bottom 3px solid rgb(217, 222, 225)
